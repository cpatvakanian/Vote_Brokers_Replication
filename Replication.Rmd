...
For my extension, I decided to look at missing data in the data sets and use multiple imputition to examine the robustness of the regressions found in Table 3. For my data imputation, I follow the University of Virginia StatLab article "Getting Started with Multiple Imputation in R".[^4]  
...
[^4]:\href{https://uvastatlab.github.io/2019/05/01/getting-started-with-multiple-imputation-in-r/}{{\underline{"Getting Started with Multiple Imputation in R"}}}
...
imp_1 <- mice(rus2, method="pmm", m=1, nnet.MaxNWts = 2000, remove_collinear = FALSE, seed=2020)

```

```{r testing which iteration works best}
